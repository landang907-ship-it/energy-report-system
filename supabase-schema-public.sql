-- ============================================
-- SUPABASE DATABASE SCHEMA - PUBLIC ACCESS
-- Energy Report System - Báo Cáo Năng Lượng
-- Phiên bản cho phép Anonymous Access (không cần đăng nhập)
-- ============================================
...
-- ============================================
-- 6. USERS - Bảng người dùng (cho quản lý admin)
-- ============================================
...
-- ============================================
-- 7. PRICING - Bảng đơn giá năng lượng
-- ============================================
...
-- HOÀN TẤT
-- ============================================
select '✅ Database schema PUBLIC ACCESS đã được tạo thành công!' as status;